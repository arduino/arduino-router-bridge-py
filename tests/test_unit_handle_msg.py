...
class TestHandleMsg(UnitTest):
    ...
    def test_malformed_messages(self):
        ...
        self.mock_logger.error.assert_called_once_with(
            "Message validation error: Invalid RPC request: expected length 4, got 5"
        )
        self.mock_logger.reset_mock()
        client._handle_msg([0, 1, "method", 1])  # Malformed params
        self.mock_logger.warning.assert_not_called()
        self.mock_logger.error.assert_called_once_with(
            "Message validation error: Invalid RPC request params: expected array or tuple"
        )
        self.mock_logger.reset_mock()
        ...
        self.mock_logger.warning.assert_not_called()
        self.mock_logger.error.assert_called_once_with(
            "Message validation error: Invalid RPC response: expected length 4, got 5"
        )
        self.mock_logger.reset_mock()
        ...
        self.mock_logger.warning.assert_not_called()
        self.mock_logger.error.assert_called_once_with(
            "Message validation error: Invalid RPC notification: expected length 3, got 4"
        )
        self.mock_logger.reset_mock()
        client._handle_msg([2, 1, 42])  # Malformed params
        self.mock_logger.warning.assert_not_called()
        self.mock_logger.error.assert_called_once_with(
            "Message validation error: Invalid RPC notification params: expected array or tuple"
        )
        self.mock_logger.reset_mock()
